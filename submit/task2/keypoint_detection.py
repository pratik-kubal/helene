...
@author: pratik
"""
from functions import rgbToGrayscale,genOctave,convolve,genGaussianKernel,differenceGaussians,findMinimaMaxima,ecl_distance,normImage
import cv2
import numpy as np

a = cv2.imread("./task2.jpg")
b = rgbToGrayscale(a)
...
# 2nd arg - 1st arg
print("Calc Difference of Gaussians")
